...
namespace Facebook.Web
{
    ...
    /// </summary>
    public sealed class FacebookSignedRequestOld
    {
        /// <summary>
        ...
        public FacebookSignedRequestOld(IDictionary<string, object> value)
        {
        ...
        /// </remarks>
        internal static FacebookSignedRequestOld Parse(string secret, string signedRequestValue, int maxAge, double currentTime)
        {
            ...
            return new FacebookSignedRequestOld(result);
        }

        public static FacebookSignedRequestOld Parse(string secret, string signedRequestValue, int maxAge)
        {
            return Parse(secret, signedRequestValue, maxAge, FacebookUtils.ToUnixTime(DateTime.UtcNow));
        }

        public static FacebookSignedRequestOld Parse(string secret, string signedRequestValue)
        {
