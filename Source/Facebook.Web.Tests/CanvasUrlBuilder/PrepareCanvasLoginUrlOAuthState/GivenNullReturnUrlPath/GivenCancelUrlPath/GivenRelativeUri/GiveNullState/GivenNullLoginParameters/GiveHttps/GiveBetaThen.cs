namespace Facebook.Web.Tests.CanvasUrlBuilder.PrepareCanvasLoginUrlOAuthState.GivenNullReturnUrlPath.GivenCancelUrlPath.GivenRelativeUri.GiveNullState.GivenNullLoginParameters.GiveHttps
{
    using System;
    ...
    public class GivenBetaThen
    {
        ...
        public void CIsSetCorrectly(string cancelUrlPath)
        {
            ...
            Assert.Equal("https://apps.beta.facebook.com/csharpsamplestwo/" + cancelUrlPath, result["c"]);
        }
