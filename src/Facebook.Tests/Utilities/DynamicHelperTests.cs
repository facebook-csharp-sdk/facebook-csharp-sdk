...
namespace Facebook.Tests.Utilities
{
    ...
    public class DynamicHelperTests
    {
        ...
        public void Merge_Only_First_Provided()
        {
            ...
            first.prop1 = "value1";
            first.prop2 = "value2";
            dynamic result = DictionaryExtensions.Merge(first, null);
        ...
        public void Merge_Only_Second_Provided()
        {
            ...
            second.prop1 = "value1";
            second.prop2 = "value2";
            dynamic result = DictionaryExtensions.Merge(null, second);
        ...
        public void Merge_Both_Provided()
        {
            ...
            second.prop3 = "value3";
            dynamic result = DictionaryExtensions.Merge(first, second);
            Assert.AreEqual(second.prop1, result.prop1);
            Assert.AreEqual(first.prop2, result.prop2);
        ...
        {
            dynamic result = DictionaryExtensions.Merge(null, null);
