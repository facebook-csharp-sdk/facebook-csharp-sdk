...
$projVsDocPath = Join-Path $projectFolder Scripts\jquery-1.6.2-vsdoc.js
$origVsDocPath = Join-Path $installPath Content\Scripts\jquery-1.6.2-vsdoc.js
$origVsDocParaPath = Join-Path $toolsPath jquery-1.6.2-vsdoc-para.js
